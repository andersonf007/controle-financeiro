        ...
        child: Padding(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton(
              ...
              value: selectedDate,
              elevation: 10,
              icon: Icon(Icons.arrow_drop_down_outlined, size: 28.sp),
              onChanged: (value) {
                if (this.forAnalysis) {
                  context.read<ChangeSelectedDate>().changeSelectedAnalysisDate(newSelectedDate: value.toString());
                  sharedPrefs.selectedDate = value.toString();
                } else {
                  context.read<ChangeSelectedDate>().changeSelectedReportDate(newSelectedDate: value.toString());
                }
              },
              items: timeline
                  .map(
