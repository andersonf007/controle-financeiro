...
class _UserAccountState extends State<UserAccount> {
  List<String> textList = ["Personal information", "Account link", "Change password", "sign out"];
  List<IconData> iconList = [Icons.person, Icons.link_sharp, Icons.admin_panel_settings_sharp, Icons.logout];
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Container(height: 60.h, color: Color.fromRGBO(237, 240, 243, 1)),
          Divider(height: 1.h, thickness: 0.8.w, color: grey),
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            IconButton(
                              icon: Icon(iconList[int], size: 30.sp),
                              onPressed: () async {
                            ...
                            SizedBox(width: 10.w),
                            Text(textList[int], style: TextStyle(fontSize: 25.sp)),
                            Spacer(),
