...
class SignIn extends StatelessWidget {
  ...
  Future<String?> _loginUser(LoginData data) async {
    print('Login: ${data.name} / ${data.password}');
    // Retorne null se o login for bem-sucedido, ou uma string de erro
    return FirebaseAuthentication.loginUser(data.name, data.password);
  }

  Future<String?> _signupUser(SignupData data) async {
    print('Signup: ${data.name} / ${data.password}');
    // Retorne null se o cadastro for bem-sucedido, ou uma string de erro
    return FirebaseAuthentication.signupUser(data.name!, data.password!);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FlutterLogin(
      ...
      messages: LoginMessages(userHint: 'User', passwordHint: 'Pass', confirmPasswordHint: 'Confirm', loginButton: 'LOG-IN', signupButton: 'REGISTER', forgotPasswordButton: 'Forgot huh?', recoverPasswordButton: 'HELP ME', goBackButton: 'GO BACK', confirmPasswordError: 'Not match!', recoverPasswordDescription: 'recoverPasswordDescription', recoverPasswordSuccess: 'Password rescued successfully'),
