    ...
    return ChangeNotifierProvider<ChangeExpenseItemEdit>(
      ...
      child: Builder(
        builder: (contextEdit) => Scaffold(
          ...
          appBar: EditCategoryAppBar(AddCategory(contextEx: widget.buildContext, contextExEdit: contextEdit, type: 'Expense', appBarTitle: getTranslated(context, 'Add Expense Category')!, description: '')),
          body: ExpenseCategoryBody(contextExEdit: contextEdit, contextEx: widget.buildContext),
        ),
      ),
    );
  }
