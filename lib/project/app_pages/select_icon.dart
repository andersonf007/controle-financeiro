...
class SelectIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<CategoryItem> icons = createItemList(forAnalysisPage: false, isIncomeType: false, forSelectIconPage: true);
    return Scaffold(
              ...
              children: [
                IconButton(
                  ...
                  icon: CircleAvatar(
                    ...
                    radius: 24.r,
                    child: Icon(iconData(icons[index]), size: 30.sp, color: this.type == 'Income' ? green : red),
                  ),
                ),
              ],
            ),
